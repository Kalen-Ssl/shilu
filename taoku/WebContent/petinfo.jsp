		...
		<div class="container">
			<div>
				...
				<div style="margin:0 auto;width:950px;">
					<div class="col-md-6">
						<img style="opacity: 1;width:400px;height:350px;" title="" class="medium" src="img/dog1.jpg">
					</div>
					...
					<div class="col-md-6">
						...
						<div style="margin:10px 0 10px 0;">宠物名字: <a target="_blank" >${pet.name }</a> </div>
						<div style="margin:10px 0 10px 0;">备注: <a target="_blank" >${pet.describe }</a> </div>
