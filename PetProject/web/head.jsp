	...
	<div class="container-fluid">
		...
		<div class="col-md-6" style="padding-top:20px">
			<ol class="list-inline">
				...
				<li id="user"></li><!-- 欢迎信息 -->
				<li><a href="UserAbout?cmd=logout" id="logout"></a></li><!-- 退出登陆选项 -->
				<li><a href="UserAbout?cmd=cart&id=<%
				   Cookie cookie = null;
				   Cookie[] cookies = null;
				...
				%>" id="cart"></a></li> <!-- 购物车选项 -->
				<li><a href="UserAbout?cmd=history" id="history"></a></li><!-- 购买历史选项 -->
			</ol>
		</div>
	</div>
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
						...
						<li><a href="PetAbout?cmd=list&sort=rabbit">宠物兔</a></li>
						<li><a href="PetAbout?cmd=list&sort=mouse">宠物仓鼠</a></li>
					</ul>
					<!--  
...
<script>
	...
	function checkUserStat(){
		...
		if ("null" != name){
			...
			document.getElementById("history").innerHTML = "购买历史";
